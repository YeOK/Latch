...
Download from **[GitHub Releases](https://github.com/YeOK/Latch/releases)** (`latch-0.3.0.3.tar.gz` + `SHA256SUMS`):

```bash
sha256sum -c SHA256SUMS
tar -xzf latch-0.3.0.3.tar.gz
cd latch-0.3.0.3-stage/source
